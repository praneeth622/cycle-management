      ...
      <div className="bg-white py-18 sm:py-10 sm:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-base font-semibold leading-7 text-indigo-600">Making better</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Featuers of GearUpCycle
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
              GearUpCycle offers convenient cycle rentals with flexible durations, diverse bike options, and reliable customer support for an enjoyable cycling experience.
              </p>
            </div>
